...
var sketch = quick_draw_data_set[Math.floor(Math.random() * quick_draw_data_set.length)];
console.log(sketch)
document.getElementById("sketch-draw").innerHTML = "Sketch to be drawn: " + sketch;
var timer_counter = 0;
var timer_check = "";
var drawn_sketch = "";
var answer_holder = "";
...
function updateCanvas(){
    background("white"); 
    sketch = quick_draw_data_set[Math.floor(Math.random() * quick_draw_data_set.length)];
    document.getElementById("sketch-draw").innerHTML = "Sketch to be drawn: " + sketch;
    console.log(sketch)
}
function draw(){
